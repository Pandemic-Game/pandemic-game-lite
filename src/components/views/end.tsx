...
export function Ending(props: {
  ...
  return (
    ...
    >
      ...
      <EndResultCopyToClipboard text="Share" />
    ...
    >
      ...
      <div className="w-full p-2 flex flex-col justify-center items-center bg-yellow-300">
        ...
        <div className="max-w-xs p-2 m-2 flex flex-col justify-center items-center">
          ...
          <Txt.Text
            value="Flip-floppers focus on giving the public what they want. For example, Boris Johnson (UK)."
            col="black"
          />
        </div>
        <div className="max-w-xs p-2 m-2 flex flex-col justify-center items-center">
          ...
          <Txt.Text
            value="Once Gheghis Cannots make a choice they do not listen to new evidence (e.g., Donald Trump, USA)"
            col="black"
          />
        </div>
      </div>
      ...
      <div className="w-full p-2 flex flex-col justify-center items-center bg-green-400">
        ...
        <div className="max-w-xs p-2 m-2 flex flex-col justify-center items-center">
          ...
          <Txt.Text
            value="COVID eliminators seek to achieve a zero-covid world by implementing strict lockdowns (e.g., Jacinda Ardern, New Zealand)"
            col="black"
          />
        </div>
        <div className="max-w-xs p-2 m-2 flex flex-col justify-center items-center">
          ...
          <p className="font-bold">X in X people are Y</p>
          <Txt.Text
            value="Economy savers deal first with COVID so that businesses can open up (e.g., Chung Seye-Kyun, South Korea)"
            col="black"
          />
        </div>
      </div>
