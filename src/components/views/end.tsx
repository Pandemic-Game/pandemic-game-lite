    ...
    return <div className={`min-h-full flex flex-col items-center text-center ${bgColorClass}`}>
        ...
        <div className='w-full p-2 m-2 flex flex-col justify-center items-center rounded-lg bg-yellow-300'>
            ...
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                ...
                <p className='font-custom text-xl m-2'>1 in 4 people are Flip-Floppers (25%)</p>
                <Txt.Text value='Flip-floppers try to please everyone and end up pleasing no-one.' col='black' />
            </div>
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                <Btn.Rounded
                    bg='yellow-600'
                ...
                <p className='font-custom text-xl m-2'>1 in 10 people are Ghenghis Cannots (10%)</p>
                <Txt.Text value='Once Gheghis Cannots make a choice they do not listen to new evidence.' col='black' />
            </div>
        </div>
        ...
        <div className='w-full p-2 m-2 flex flex-col justify-center items-center rounded-lg bg-green-400'>
            ...
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                ...
                <p className='font-custom text-xl m-2'>1 in 5 people are COVID-Terminators (20%)</p>
                <Txt.Text value='COVID terminators seek to achieve a zero-covid world by implementing strict lockdowns.' col='black' />
            </div>
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                <Btn.Rounded
                    bg='blue-500'
                ...
                <p className='font-custom text-xl m-2'>1 in 2 people are Business Gurus (45%)</p>
                <Txt.Text value='Business Gurus deal first with COVID so that businesses can open up.' col='black' />
            </div>
        </div>
