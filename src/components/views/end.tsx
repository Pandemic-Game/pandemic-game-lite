...
export function AllEndings(props: {onClick: Function}){
    return <div className={`min-h-full flex flex-col justify-between items-center text-center bg-yellow-500`}>
        <div className='p-2 flex flex-col justify-between items-center '>
            <Txt.Subtitle value='Find out about the other'/>
        ...
        <div className='w-full p-2 flex flex-col justify-center items-center bg-yellow-300'>
            ...
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                ...
                <Txt.Text value='Flip-floppers focus on giving the public what they want. For example, Boris Johnson (UK).' />
            </div>
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                <Btn.Rounded 
                    bg='yellow-600'
                ...
                <Txt.Text value='Once Gheghis Cannots make a choice they do not listen to new evidence (e.g., Donald Trump, USA)' />
            </div>
        </div>
        ...
        <div className='w-full p-2 flex flex-col justify-center items-center bg-green-400'>
            ...
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                ...
                <Txt.Text value='COVID eliminators seek to achieve a zero-covid world by implementing strict lockdowns (e.g., Jacinda Ardern, New Zealand)' />
            </div>
            <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center' >
                <Btn.Rounded 
                    bg='green-600'
                ...
                <p className='font-bold'>X in X people are Y</p>
                <Txt.Text value='Economy savers deal first with COVID so that businesses can open up (e.g., Chung Seye-Kyun, South Korea)' />
            </div>
        </div>

        <div className='max-w-xs p-2 m-2 flex flex-col justify-center items-center'>
            <Txt.Subtitle value='How do we calculate these?' />
            <Txt.Text value='We showed you a scenario where you could have responded in different ways. Your responses have consequences later down the line, like a story tree.' />
        </div>
    </div> 
